...
function init() {
    inquirer
        .prompt([
            ...
            {
                type: "input",
                message: "Please enter a color for your text using a color keyword OR hexidecimal color code",
                name: "textColor",
            },
            {
                type: "list",
            ...
            {
                type: "input",
                message: "Please enter a color for your shape using a color keyword OR hexidecimal color code",
                name: "shapeColor"
            },
        ])
        .then((response) => {
